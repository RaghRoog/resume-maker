...
import fontRegular from '../fonts/roboto/RobotoSlab-Regular.ttf'
import fontBold from '../fonts/roboto/RobotoSlab-SemiBold.ttf'

export default function Template2({ inputsData }) {
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.left}>
                    <View style={styles.leftTop}>
                        <Text style={{fontFamily: 'bold', fontSize: '20px'}}>
